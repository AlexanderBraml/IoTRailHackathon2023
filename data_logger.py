...
class DataLogger():
    ...
    def run(self, file_name=DEFAULT_FILE_NAME, record=DEFAULT_RECORD, uids=[DEFAULT_UID_IN, DEFAULT_UID_OUT], host=DEFAULT_HOST, port=DEFAULT_PORT):
...
def main():
    ...
    data_logger.run(file_name=args.f, record=args.r)
